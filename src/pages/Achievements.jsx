...
function AchievementCard({ achievement }) {
  ...
  return (
    <motion.div
      ...
      className="h-full"
    >
      <div className="relative flex h-full flex-col overflow-hidden rounded-2xl border border-[color:var(--color-glow-accent)]/20 bg-gradient-to-br from-[color:var(--color-bg-mid)] to-[color:var(--color-bg-base)] p-6 shadow-[0_0_30px_-10px_rgba(var(--color-glow-accent-rgb),0.25)]">
        <div
          className="pointer-events-none absolute -right-10 -top-10 h-40 w-40 rounded-full bg-[color:var(--color-glow-accent)]/10 blur-3xl"
          aria-hidden="true"
        />
        <MedalIcon className="relative z-10 h-8 w-8 text-[color:var(--color-glow-accent)]" />
        ...
        {isTruncated && (
          <button
            ...
            className="relative z-10 mt-4 self-start text-xs text-[color:var(--color-glow-accent)]"
          >
